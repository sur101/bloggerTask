...
function review() {
    return (
        <div className='flex justify-center h-screen'>
            < div className='w-[500px] shadow-lg p-8 h-full'>
                ...
                <div className='w-full font-semibold bg-indigo-300 py-2 flex justify-center rounded-md cursor-pointer transition transform hover:scale-105 duration-150 active:scale-95'>
                    <h2>
                        Submit
                    </h2>
